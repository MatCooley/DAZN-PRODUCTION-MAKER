import { days, shifts, slotOrder } from '../lib/data';
import type { Assignments, ComplianceFlag, Employee } from '../lib/types';
...
export function Board({
  ...
  return (
    <div className="grid flex-1 grid-cols-7 gap-2.5 overflow-x-auto p-3">
      {days.map((day) => {
